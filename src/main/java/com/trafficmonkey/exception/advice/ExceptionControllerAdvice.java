package com.trafficmonkey.exception.advice;
...
import com.trafficmonkey.DTO.error.Error;
import com.trafficmonkey.exception.BadRequestException;
import com.trafficmonkey.exception.ObjectNotFoundException;
import com.trafficmonkey.exception.TrafficMonkeyException;
import com.trafficmonkey.exception.TrafficMonkeySystemException;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(value = { Exception.class, TrafficMonkeySystemException.class })
	   ...
	   */
	  @ExceptionHandler(TrafficMonkeyException.class)
	  public ResponseEntity<Object> trafficMonkeyExceptionHandler(TrafficMonkeyException exception) {
	    Error error = null;
